...
$qry="update plans set status=1,payment_status=0 where plan_id= '$var' ";
...
<script type="text/javascript">
	alert("Your plan has been successfully selected. To officially complete the procedure please issue a NEFT payment to account No: 1236598745136. Check my plans to see its status");
 location='index.php';
</script>
